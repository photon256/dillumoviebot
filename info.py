...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002257796076').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002257796076') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002257796076')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002257796076')
...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://dildaaryaara:dildarcluster01@cluster0.hpxj6.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0") # IF Multiple Database Is False Then Fill Only This Database Url.
...
PAYMENT_TEXT = environ.get('PAYMENT_TEXT', 'Nothing')
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/hshhsvhhd')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/LINKKHOLNE')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'hshhsvhhd') # Support Chat Link Without https:// or @
...
VERIFY_SHORTLINK_API = environ.get('VERIFY_SHORTLINK_API', '49dfd48246afe5b02077559e38bba26969a80351')
